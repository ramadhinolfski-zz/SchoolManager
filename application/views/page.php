				...
				<section class="style-default-bright">
					...
					<div class="section-body">
						...
						<div class="row">
							...
							<div class="col-lg-12">
								<div class="table-responsive">
									<table id="datatable2" class="table order-column hover" data-source="<?php echo base_url(); ?>/data/users.json" data-swftools="<?php echo base_url(); ?>assets/js/libs/DataTables/extensions/TableTools/swf/copy_csv_xls_pdf.swf">
										<thead>
											<tr>
												<th></th>
												<th>Name</th>
